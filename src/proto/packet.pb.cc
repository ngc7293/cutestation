...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fpacket_2eproto = {
  &descriptor_table_proto_2fpacket_2eproto_initialized, descriptor_table_protodef_proto_2fpacket_2eproto, "proto/packet.proto", 88,
  &descriptor_table_proto_2fpacket_2eproto_once, descriptor_table_proto_2fpacket_2eproto_sccs, descriptor_table_proto_2fpacket_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_proto_2fpacket_2eproto::offsets,
  file_level_metadata_proto_2fpacket_2eproto, 1, file_level_enum_descriptors_proto_2fpacket_2eproto, file_level_service_descriptors_proto_2fpacket_2eproto,
};
