...
_sym_db.RegisterEnumDescriptor(_HANDSHAKE_COMMAND_TYPE)


_HANDSHAKE_COMMAND = _descriptor.Descriptor(
  name='Command',
  full_name='cute.proto.Handshake.Command',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='cute.proto.Handshake.Command.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='cute.proto.Handshake.Command.type', index=1,
...
_HANDSHAKE = _descriptor.Descriptor(
  ...
  nested_types=[_HANDSHAKE_COMMAND, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_MEASUREMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bool', full_name='cute.proto.Measurement.bool', index=5,
...
_HANDSHAKE_COMMAND.fields_by_name['type'].enum_type = _HANDSHAKE_COMMAND_TYPE
_HANDSHAKE_COMMAND.containing_type = _HANDSHAKE
_HANDSHAKE_COMMAND_TYPE.containing_type = _HANDSHAKE_COMMAND
_HANDSHAKE.fields_by_name['commands'].message_type = _HANDSHAKE_COMMAND
...
_MEASUREMENT.oneofs_by_name['value'].fields.append(
  _MEASUREMENT.fields_by_name['bool'])
_MEASUREMENT.fields_by_name['bool'].containing_oneof = _MEASUREMENT.oneofs_by_name['value']
...
Handshake = _reflection.GeneratedProtocolMessageType('Handshake', (_message.Message,), {
  ...
  'Command' : _reflection.GeneratedProtocolMessageType('Command', (_message.Message,), {
    'DESCRIPTOR' : _HANDSHAKE_COMMAND,
    '__module__' : 'packet_pb2'
    # @@protoc_insertion_point(class_scope:cute.proto.Handshake.Command)
    })
  ,
...
_sym_db.RegisterMessage(Handshake.Command)
